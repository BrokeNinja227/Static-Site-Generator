...
def generate_page(from_path, template_path, dest_path, basepath):
    ...
    second_replacement = first_replacement.replace("{{ Content }}", md_html)
    third_replacement = second_replacement.replace('href="/', f'href="{basepath}')
    full_HTML_file = third_replacement.replace('src="/', f'src="{basepath}')
...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path, basepath):
    for entry in os.listdir(dir_path_content):
        ...
        if os.path.isdir(entry_path):
            ...
            generate_page(entry_path, template_path, page_dest_path, basepath)
